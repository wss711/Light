...
import com.gr.light.advanceview.toolbar.WssToolbarActivity;
...
public class WssAdvanceViewActivity extends BaseActivity {
    ...
    @OnClick({R.id.listview_btn, R.id.gridview_btn, R.id.recyclerview_btn, R.id.cardview_btn, R.id.viewpager_btn, R.id.bottomNavigation_view_btn,
            R.id.tablayout_btn, R.id.notification_btn,R.id.toolbar_btn})
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.toolbar_btn:
                startActivity(new Intent(WssAdvanceViewActivity.this, WssToolbarActivity.class));
